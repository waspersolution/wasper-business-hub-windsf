        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <Card className="col-span-1">
            <CardHeader>
              ...
              <CardDescription>Follow these steps to import your products</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                <Badge>2</Badge>
                <p className="text-sm">Fill in your product data</p>
              </div>
              <div className="flex items-center gap-2">
                <Badge>3</Badge>
                    ...
                    <Table>
                      ...
                      <TableBody>
                        {mockPreviewData.map((row, index) => (
                          <TableRow key={index}>
                            <TableCell>{row.sku || <span className="text-red-500">Missing</span>}</TableCell>
                            <TableCell>{row.name}</TableCell>
                            <TableCell>{row.category}</TableCell>
                            <TableCell>{row.price}</TableCell>
                            <TableCell>{row.cost}</TableCell>
                            <TableCell>
                              {row.stock === "abc" ? <span className="text-amber-500">Invalid</span> : row.stock}
                            </TableCell>
                            <TableCell>
                              {row.status === "valid" ? (
                ...
                <CardFooter className="border-t pt-6">
                  <div className="flex items-center justify-between w-full">
                    <div>
                      ...
                      <p className="text-sm text-amber-600">3 valid items, 2 with issues</p>
                    </div>
                    <div className="flex gap-3">
                      <Button variant="outline">Cancel</Button>
                      <Button disabled={isProcessing}>Import Products</Button>
                    </div>
                  </div>
                </CardFooter>
              </>
